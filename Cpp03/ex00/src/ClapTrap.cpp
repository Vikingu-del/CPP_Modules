...
/*   Updated: 2024/03/08 16:31:59 by eseferi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage( unsigned int amount ) {
    if (this->_hitPoints < 1)
        std::cout << GREEN << "ClapTrap " << this->_name << " has no hit points left!" << RESET << std::endl;
    else {
        std::cout << GREEN << "ClapTrap " << this->_name << " takes " << amount << " points of damage!" << RESET << std::endl;
...
void ClapTrap::beRepaired( unsigned int amount ) {
    std::cout << GREEN<< "ClapTrap " << this->_name << " has been repaired for " << amount << " hit points!" << RESET << std::endl;
    this->_hitPoints += amount;
}
