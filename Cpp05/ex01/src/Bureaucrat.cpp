...
/*   Updated: 2024/03/14 23:18:13 by eseferi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm( Form &form ) {
    if ( this->_grade > form.getGradeToSign() )
        std::cout << YELLOW << this->_name << " cannot sign " << form.getName() << " because grade is too low!" << RESET << std::endl;
    else if ( form.getSigned() )
        std::cout << YELLOW << form.getName() << " is already signed!" << RESET << std::endl;
    else {
        form.beSigned( *this );
